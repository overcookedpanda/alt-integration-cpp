...
struct BlockRepositoryMock : public BlockRepository<Block> {
  ...
  MOCK_METHOD2_T(getByHash, bool(const hash_t&, stored_block_t*));
  MOCK_METHOD2_T(getByHeight, bool(height_t, std::vector<stored_block_t>*));
  MOCK_METHOD2_T(getManyByHash,
